...
(4, 'server_baseurl', 'URL du serveur', 'application.24heures.org'),
...
(8, 'animations_db_path', 'Chemin vers la BDD des anims', '/var/www/animaker/Backend/Data/DB/DB.sqlite'),
(9, 'manifestation_edition', 'Numéro de l''édition', '38');
