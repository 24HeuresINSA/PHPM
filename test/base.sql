...
(12, 3, NULL, ' MARTIN ', ' MARIE ', ' Pseudo ', ' 0678965412 ', ' MARTIN.MARIE@insa-lyon.fr ', '1988-02-15', ' 64 ', NULL, 1, 1, 0),
(13, 3, NULL, ' JEANNE ', ' DUVAL ', ' Pseudo ', ' 0678965413 ', ' JEANNE.DUVAL@insa-lyon.fr ', '1989-02-15', ' 61 ', NULL, 0, 1, 0),
(14, 3, NULL, ' HEBERT ', ' LEFEVRE ', ' Pseudo ', ' 0678965414 ', ' HEBERT.LEFEVRE@insa-lyon.fr ', '1999-02-15', ' 8 ', NULL, 1, 1, 0),
(15, 3, NULL, ' GAUTIER ', ' LEROY ', ' Pseudo ', ' 0678965415 ', ' GAUTIER.LEROY@insa-lyon.fr ', '1985-02-15', ' 60 ', NULL, 2, 1, 0),
(16, 2, NULL, ' HAMEL ', ' GUERIN ', ' Pseudo ', ' 0678965416 ', ' HAMEL.GUERIN@insa-lyon.fr ', '1986-02-15', ' 80 ', NULL, 2, 1, 0),
(17, 2, NULL, ' LECONTE ', ' SIMON ', ' Pseudo ', ' 0678965417 ', ' LECONTE.SIMON@insa-lyon.fr ', '1993-02-15', ' 80 ', NULL, 2, 1, 0),
(18, 2, NULL, ' DURAND ', ' LEMONNIER ', ' Pseudo ', ' 0678965418 ', ' DURAND.LEMONNIER@insa-lyon.fr ', '1976-02-15', ' 16 ', NULL, 0, 1, 0),
(19, 3, NULL, ' LEROUX ', ' LELIEVRE ', ' Pseudo ', ' 0678965419 ', ' LEROUX.LELIEVRE@insa-lyon.fr ', '1971-02-15', ' 18 ', NULL, 1, 1, 0),
(20, 3, NULL, ' MORIN ', ' LANGLOIS ', ' Pseudo ', ' 0678965420 ', ' MORIN.LANGLOIS@insa-lyon.fr ', '1997-02-15', ' 2 ', NULL, 0, 1, 0),
(21, 2, NULL, ' MOREL ', ' DUPONT ', ' Pseudo ', ' 0678965421 ', ' MOREL.DUPONT@insa-lyon.fr ', '1998-02-15', ' 32 ', NULL, 1, 1, 0),
(22, 3, NULL, ' ANNE ', ' MICHEL ', ' Pseudo ', ' 0678965422 ', ' ANNE.MICHEL@insa-lyon.fr ', '1993-02-15', ' 65 ', NULL, 2, 1, 0),
(23, 3, NULL, ' DUBOIS ', ' JEAN ', ' Pseudo ', ' 0678965423 ', ' DUBOIS.JEAN@insa-lyon.fr ', '1998-02-15', ' 73 ', NULL, 2, 1, 0),
(24, 2, NULL, ' FONTAINE ', ' DELAUNAY ', ' Pseudo ', ' 0678965424 ', ' FONTAINE.DELAUNAY@insa-lyon.fr ', '1980-02-15', ' 41 ', NULL, 0, 1, 0),
(25, 3, NULL, ' GOSSELIN ', ' HUET ', ' Pseudo ', ' 0678965425 ', ' GOSSELIN.HUET@insa-lyon.fr ', '1997-02-15', ' 34 ', NULL, 0, 1, 0),
(26, 2, NULL, ' LETELLIER ', ' MAUGER ', ' Pseudo ', ' 0678965426 ', ' LETELLIER.MAUGER@insa-lyon.fr ', '1984-02-15', ' 64 ', NULL, 1, 1, 0),
(27, 3, NULL, ' LECLERC ', ' FLEURY ', ' Pseudo ', ' 0678965427 ', ' LECLERC.FLEURY@insa-lyon.fr ', '1993-02-15', ' 16 ', NULL, 1, 1, 0),
(28, 3, NULL, ' ROUSSEL ', ' LAURENT ', ' Pseudo ', ' 0678965428 ', ' ROUSSEL.LAURENT@insa-lyon.fr ', '1991-02-15', ' 47 ', NULL, 2, 1, 0),
(29, 3, NULL, ' LAUNAY ', ' RICHARD ', ' Pseudo ', ' 0678965429 ', ' LAUNAY.RICHARD@insa-lyon.fr ', '1997-02-15', ' 3 ', NULL, 2, 1, 0),
(30, 3, NULL, ' GARNIER ', ' LEGRAND ', ' Pseudo ', ' 0678965430 ', ' GARNIER.LEGRAND@insa-lyon.fr ', '1990-02-15', ' 32 ', NULL, 2, 1, 0),
(31, 3, NULL, ' AUVRAY ', ' LEMOINE ', ' Pseudo ', ' 0678965431 ', ' AUVRAY.LEMOINE@insa-lyon.fr ', '1974-02-15', ' 28 ', NULL, 1, 1, 0),
(32, 3, NULL, ' ROGER ', ' THOMAS ', ' Pseudo ', ' 0678965432 ', ' ROGER.THOMAS@insa-lyon.fr ', '1989-02-15', ' 90 ', NULL, 0, 1, 0),
(33, 3, NULL, ' AUBERT ', ' LEFRANCOIS ', ' Pseudo ', ' 0678965433 ', ' AUBERT.LEFRANCOIS@insa-lyon.fr ', '1974-02-15', ' 64 ', NULL, 2, 1, 0),
(34, 2, NULL, ' DAVID ', ' BISSON ', ' Pseudo ', ' 0678965434 ', ' DAVID.BISSON@insa-lyon.fr ', '1981-02-15', ' 81 ', NULL, 0, 1, 0),
(35, 3, NULL, ' CATHERINE ', ' ADAM ', ' Pseudo ', ' 0678965435 ', ' CATHERINE.ADAM@insa-lyon.fr ', '1975-02-15', ' 85 ', NULL, 2, 1, 0),
(36, 2, NULL, ' LEMARCHAND ', ' VOISIN ', ' Pseudo ', ' 0678965436 ', ' LEMARCHAND.VOISIN@insa-lyon.fr ', '1996-02-15', ' 23 ', NULL, 2, 1, 0),
(37, 3, NULL, ' HUBERT ', ' DENIS ', ' Pseudo ', ' 0678965437 ', ' HUBERT.DENIS@insa-lyon.fr ', '1970-02-15', ' 60 ', NULL, 1, 1, 0),
(38, 3, NULL, ' NOEL ', ' POTTIER ', ' Pseudo ', ' 0678965438 ', ' NOEL.POTTIER@insa-lyon.fr ', '1984-02-15', ' 65 ', NULL, 0, 1, 0),
(39, 3, NULL, ' PHILIPPE ', ' RENAULT ', ' Pseudo ', ' 0678965439 ', ' PHILIPPE.RENAULT@insa-lyon.fr ', '2000-02-15', ' 64 ', NULL, 0, 1, 0),
(40, 3, NULL, ' LEPETIT ', ' OLIVIER ', ' Pseudo ', ' 0678965440 ', ' LEPETIT.OLIVIER@insa-lyon.fr ', '1998-02-15', ' 14 ', NULL, 2, 1, 0),
(41, 3, NULL, ' LEBRETON ', ' BESNARD ', ' Pseudo ', ' 0678965441 ', ' LEBRETON.BESNARD@insa-lyon.fr ', '1981-02-15', ' 28 ', NULL, 2, 1, 0),
(42, 2, NULL, ' HUE ', ' MOULIN ', ' Pseudo ', ' 0678965442 ', ' HUE.MOULIN@insa-lyon.fr ', '1972-02-15', ' 58 ', NULL, 0, 1, 0),
(43, 3, NULL, ' LETOURNEUR ', ' LEMAITRE ', ' Pseudo ', ' 0678965443 ', ' LETOURNEUR.LEMAITRE@insa-lyon.fr ', '1987-02-15', ' 19 ', NULL, 0, 1, 0),
(44, 2, NULL, ' JAMES ', ' LAINE ', ' Pseudo ', ' 0678965444 ', ' JAMES.LAINE@insa-lyon.fr ', '2000-02-15', ' 82 ', NULL, 0, 1, 0),
(45, 2, NULL, ' RENOUF ', ' LUCAS ', ' Pseudo ', ' 0678965445 ', ' RENOUF.LUCAS@insa-lyon.fr ', '1971-02-15', ' 16 ', NULL, 1, 1, 0),
(46, 2, NULL, ' PICOT ', ' GIRARD ', ' Pseudo ', ' 0678965446 ', ' PICOT.GIRARD@insa-lyon.fr ', '1982-02-15', ' 33 ', NULL, 1, 1, 0),
(47, 2, NULL, ' VALLEE ', ' DUCHEMIN ', ' Pseudo ', ' 0678965447 ', ' VALLEE.DUCHEMIN@insa-lyon.fr ', '1978-02-15', ' 46 ', NULL, 1, 1, 0),
(48, 2, NULL, ' MENARD ', ' VAUTIER ', ' Pseudo ', ' 0678965448 ', ' MENARD.VAUTIER@insa-lyon.fr ', '1970-02-15', ' 16 ', NULL, 2, 1, 0),
(49, 2, NULL, ' BAZIN ', ' LEMIERE ', ' Pseudo ', ' 0678965449 ', ' BAZIN.LEMIERE@insa-lyon.fr ', '1973-02-15', ' 11 ', NULL, 2, 1, 0),
(50, 2, NULL, ' RIVIERE ', ' FRANCOIS ', ' Pseudo ', ' 0678965450 ', ' RIVIERE.FRANCOIS@insa-lyon.fr ', '1977-02-15', ' 82 ', NULL, 0, 1, 0),
(51, 2, NULL, ' HARDY ', ' PARIS ', ' Pseudo ', ' 0678965451 ', ' HARDY.PARIS@insa-lyon.fr ', '1972-02-15', ' 30 ', NULL, 0, 1, 0),
(52, 3, NULL, ' LECARPENTIER ', ' RENARD ', ' Pseudo ', ' 0678965452 ', ' LECARPENTIER.RENARD@insa-lyon.fr ', '1989-02-15', ' 83 ', NULL, 1, 1, 0),
(53, 2, NULL, ' DUFOUR ', ' LEBRUN ', ' Pseudo ', ' 0678965453 ', ' DUFOUR.LEBRUN@insa-lyon.fr ', '1988-02-15', ' 31 ', NULL, 1, 1, 0),
(54, 2, NULL, ' LAMY ', ' ANDRE ', ' Pseudo ', ' 0678965454 ', ' LAMY.ANDRE@insa-lyon.fr ', '1990-02-15', ' 23 ', NULL, 2, 1, 0),
(55, 3, NULL, ' BERNARD ', ' POULAIN ', ' Pseudo ', ' 0678965455 ', ' BERNARD.POULAIN@insa-lyon.fr ', '1993-02-15', ' 18 ', NULL, 2, 1, 0),
(56, 2, NULL, ' MARY ', ' POISSON ', ' Pseudo ', ' 0678965456 ', ' MARY.POISSON@insa-lyon.fr ', '1990-02-15', ' 25 ', NULL, 1, 1, 0),
(57, 3, NULL, ' BERTRAND ', ' GODEFROY ', ' Pseudo ', ' 0678965457 ', ' BERTRAND.GODEFROY@insa-lyon.fr ', '1995-02-15', ' 64 ', NULL, 1, 1, 0),
(58, 2, NULL, ' PETIT ', ' FAUVEL ', ' Pseudo ', ' 0678965458 ', ' PETIT.FAUVEL@insa-lyon.fr ', '1995-02-15', ' 32 ', NULL, 0, 1, 0),
(59, 2, NULL, ' LECOQ ', ' LEFEBVRE ', ' Pseudo ', ' 0678965459 ', ' LECOQ.LEFEBVRE@insa-lyon.fr ', '1981-02-15', ' 6 ', NULL, 2, 1, 0),
(60, 2, NULL, ' MOUCHEL ', ' HENRY ', ' Pseudo ', ' 0678965460 ', ' MOUCHEL.HENRY@insa-lyon.fr ', '1976-02-15', ' 59 ', NULL, 0, 1, 0),
(61, 3, NULL, ' LEGENDRE ', ' FRANCOISE ', ' Pseudo ', ' 0678965461 ', ' LEGENDRE.FRANCOISE@insa-lyon.fr ', '1993-02-15', ' 2 ', NULL, 0, 1, 0);
