...
class OrgaRepository extends EntityRepository
{
    ...
    */
	...
	public function getPlanning($orga_id = 'all',$equipe_id = 'all',\DateTime $debut, \DateTime $fin){
		...
		if($orga_id == ''){
			if($equipe_id == ''){
			return $this->getEntityManager()->createQuery("SELECT o,d,c,p,t,g,r,bm,m,c2,d2,o2 FROM AssoMakerBaseBundle:Orga o JOIN o.disponibilites d JOIN d.creneaux c JOIN
				...
				return $this->getEntityManager()->createQuery("SELECT o,d,c,p,t,g,r,bm,m,c2,d2,o2,e FROM AssoMakerBaseBundle:Orga o JOIN o.disponibilites d JOIN d.creneaux c JOIN
						c.plageHoraire p JOIN p.tache t JOIN t.groupeTache g JOIN t.responsable r  LEFT JOIN t.besoinsMateriel bm LEFT JOIN bm.materiel m
