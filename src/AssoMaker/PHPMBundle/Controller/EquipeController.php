...
use AssoMaker\PHPMBundle\Entity\Equipe;
...
class EquipeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AssoMakerPHPMBundle:Equipe')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AssoMakerPHPMBundle:Equipe')->find($id);
     ...
     * @Method("post")
     * @Template("AssoMakerPHPMBundle:Equipe:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("AssoMakerPHPMBundle:Equipe:edit.html.twig")
     */
