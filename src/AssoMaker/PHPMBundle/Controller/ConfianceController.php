...
class ConfianceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AssoMakerPHPMBundle:Confiance')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AssoMakerPHPMBundle:Confiance')->find($id);
     ...
     * @Method("post")
     * @Template("AssoMakerPHPMBundle:Confiance:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("AssoMakerPHPMBundle:Confiance:edit.html.twig")
     */
