...
/**
 * AssoMaker\PHPMBundle\Entity\Confiance
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="AssoMaker\PHPMBundle\Entity\ConfianceRepository")
 */
class Confiance
{
    /**
    ...
    */
     ...
     * Add equipes
     *
     * @param AssoMaker\PHPMBundle\Entity\Equipe $equipes
     */
    public function addEquipe(\AssoMaker\PHPMBundle\Entity\Equipe $equipes)
    {
