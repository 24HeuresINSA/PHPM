...
class OrgaRepository extends EntityRepository
{
	...
	{
		$dql = "SELECT o, SUM(di.pointsCharisme) charisme FROM AssoMakerPHPMBundle:Orga AS o JOIN o.disponibilitesInscription di JOIN o.disponibilites d JOIN o.equipe e WHERE o.statut>=1";
	...
	public function getOrgasCompatibleWithCreneau($creneau_id)
	{
		...
		$dql = 	"SELECT o, SUM(di.pointsCharisme) charisme FROM AssoMakerPHPMBundle:Orga AS o JOIN o.disponibilites d " . 
	...
	public function getOrgasToValidate()
	{
		...
		->createQuery("SELECT o ,SUM(d.fin-d.debut)/3600 AS nbHeures FROM AssoMakerPHPMBundle:Orga o, PHPMBundle:Disponibilite d WHERE (d.orga = o AND o.statut=0)")
	...
	public function getStats(\AssoMaker\PHPMBundle\Entity\Orga $orga)
	{
		...
		->createQuery("SELECT sum(d.pointsCharisme)FROM AssoMakerPHPMBundle:Orga o JOIN o.disponibilitesInscription d WHERE o.statut >=0")
		...
		->createQuery("SELECT count(o) FROM AssoMakerPHPMBundle:Orga o WHERE  o.statut =0")
    ...
    public function getOrgasFromRegistration()
    {
        ...
        return $this->getEntityManager()
        ->createQuery("SELECT o FROM AssoMakerPHPMBundle:Orga o WHERE (o.statut=0)")
    ...
    {
        return $this->getEntityManager()
        ->createQuery("SELECT COUNT (o.id) AS nbOrgas FROM AssoMakerPHPMBundle:Orga o WHERE (o.statut=1)")   
        ->getResult();
    }
    ...
    public function getNombreHeureInscription($oid)
    {
        ...
        ->createQuery("SELECT SUM(d.fin-d.debut)/3600 AS nbHeures FROM AssoMakerPHPMBundle:Orga o JOIN o.disponibilitesInscription d")
    ...
    */
	...
	{
		return $this->getEntityManager()
		->createQuery("SELECT o FROM AssoMakerPHPMBundle:Orga o WHERE (o.nom LIKE :s OR o.prenom LIKE :s OR o.surnom LIKE :s OR o.telephone LIKE :s OR o.email LIKE :s OR o.commentaire LIKE :s) AND o.statut != '-1'")
		->setParameter('s', "%".$s."%")
		->getResult();	
	}
	...
	public function getPlanning($orga_id = 'all',$equipe_id = 'all',\DateTime $debut, \DateTime $fin){
		...
		if($orga_id == ''){
			if($equipe_id == ''){
			return $this->getEntityManager()->createQuery("SELECT o,d,c,p,t,g,r,bm,m,c2,d2,o2 FROM AssoMakerPHPMBundle:Orga o JOIN o.disponibilites d JOIN d.creneaux c JOIN
				...
				return $this->getEntityManager()->createQuery("SELECT o,d,c,p,t,g,r,bm,m,c2,d2,o2,e FROM AssoMakerPHPMBundle:Orga o JOIN o.disponibilites d JOIN d.creneaux c JOIN
						c.plageHoraire p JOIN p.tache t JOIN t.groupeTache g JOIN t.responsable r  LEFT JOIN t.besoinsMateriel bm LEFT JOIN bm.materiel m
...
public function getOrgasWithCompatibleTache($tache_id)
	{
		...
		->from('AssoMakerPHPMBundle:Orga','o')
