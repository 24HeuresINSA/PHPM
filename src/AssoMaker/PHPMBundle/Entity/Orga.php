...
/**
 * AssoMaker\PHPMBundle\Entity\Orga
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="AssoMaker\PHPMBundle\Entity\OrgaRepository")
...
//     			"permis"=>$this->getPermis(),
     ...
     *
     * @param AssoMaker\PHPMBundle\Entity\Equipe $equipesResponsable
     */
    public function addEquipe(\AssoMaker\PHPMBundle\Entity\Equipe $equipesResponsable)
    {
