...
/**
 * AssoMaker\PHPMBundle\Entity\Lieu
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="AssoMaker\PHPMBundle\Entity\LieuRepository")
 */
class Lieu
{
    /**
    ...
    */
     ...
     * Add groupesTaches
     *
     * @param AssoMaker\PHPMBundle\Entity\GroupeTache $groupesTaches
     */
    public function addGroupeTache(\AssoMaker\PHPMBundle\Entity\GroupeTache $groupesTaches)
    {
