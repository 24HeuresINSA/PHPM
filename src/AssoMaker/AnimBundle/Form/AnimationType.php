    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        ...
        if (!$this->create) {
            $a
                    ...
                    ->add('pubPicture', null, array('label' => 'Image à mettre sur le site'))
                    ->add('animPhare', null, array('label' => 'Anim Phare'))
                    ->add('animGosses', null, array('label' => 'Anim pour les gosses'))
                    ->add('elec', null, array('label' => 'Besoin d\'éléctricité'))
                    ->add('elecAmperes', null, array('label' => 'Ampères'))
                    ->add('elecTri', null, array('label' => 'Triphasé'))
