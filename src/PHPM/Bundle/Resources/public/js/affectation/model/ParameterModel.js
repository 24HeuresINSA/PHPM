...
ParameterModel.prototype = {
	...
	getPlages: function() {
		var tab = {
					'1': {nom: 'pré-manif', jour_debut: '2012/05/23', jour_fin: '2012/05/26'},
					'2': {nom: 'manif', jour_debut: '2012/05/27', jour_fin: '2012/05/28'},
					'0': {nom: 'postmanif', jour_debut: '2012/05/29', jour_fin: '2012/05/29'}
					};
