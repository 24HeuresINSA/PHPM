...
use PHPM\Bundle\Form\CommentaireType;
...
class CommentaireController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PHPMBundle:Commentaire')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PHPMBundle:Commentaire')->find($id);
     ...
     * @Method("post")
     * @Template("PHPMBundle:Commentaire:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("PHPMBundle:Commentaire:edit.html.twig")
     */
