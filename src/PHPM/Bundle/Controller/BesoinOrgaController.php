...
use PHPM\Bundle\Form\BesoinOrgaType;
...
class BesoinOrgaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PHPMBundle:BesoinOrga')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PHPMBundle:BesoinOrga')->find($id);
     ...
     * @Method("post")
     * @Template("PHPMBundle:BesoinOrga:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("PHPMBundle:BesoinOrga:edit.html.twig")
     */
